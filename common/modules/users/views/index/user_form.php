<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		...
		<?php echo CHtml::listBox('roles', isset($_POST['roles']) ? $_POST['roles'] : isset($items_selected[ CAuthItem::TYPE_ROLE ]) ? $items_selected[ CAuthItem::TYPE_ROLE ] : '', $items[ CAuthItem::TYPE_ROLE ], array( 'size' => 10, 'multiple' => 'multiple', 'class' => 'text-input medium-input' )); ?>
		
		<?php echo CHtml::label(Yii::t('adminmembers', 'Other Assigned Tasks'), ''); ?>
		<?php echo CHtml::listBox('tasks', isset($_POST['tasks']) ? $_POST['tasks'] : isset($items_selected[ CAuthItem::TYPE_TASK ]) ? $items_selected[ CAuthItem::TYPE_TASK ] : '', $items[ CAuthItem::TYPE_TASK ], array( 'size' => 10, 'multiple' => 'multiple', 'class' => 'text-input medium-input' )); ?>
		
		<?php echo CHtml::label(Yii::t('adminmembers', 'Other Assigned Operations'), ''); ?>
		<?php echo CHtml::listBox('operations', isset($_POST['operations']) ? $_POST['operations'] : isset($items_selected[ CAuthItem::TYPE_OPERATION ]) ? $items_selected[ CAuthItem::TYPE_OPERATION ] : '', $items[ CAuthItem::TYPE_OPERATION ], array( 'size' => 10, 'multiple' => 'multiple', 'class' => 'text-input medium-input' )); ?>
...
alter table base_authassignment Add foreign key (userid) references base_users(id) on delete cascade on update cascade