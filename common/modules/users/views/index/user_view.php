<div class="content-box"><!-- Start Content Box -->
	...
	<div style='float:left;'><?php $this->widget('users.widgets.VGGravatarWidget', array( 'email' => $model->email, 'size' => 120 )); ?></div>
	<div style='margin-left: 125px;'>
		...
		<table>
			...
			<tr>
				...
				<td>
					<a href="<?php echo $this->createUrl('index/edit', array( 'id' => $model->id )); ?>" title="<?php echo Yii::t('adminmembers', 'Edit this member'); ?>">
            <img src="<?php echo Yii::app()->themeManager->baseUrl; ?>/images/icons/pencil.png" alt="Edit" /></a>
					 <a href="<?php echo $this->createUrl('index/delete', array( 'id' => $model->id )); ?>" title="<?php echo Yii::t('adminmembers', 'Delete this member!'); ?> ">
             <img src="<?php echo Yii::app()->themeManager->baseUrl; ?>/images/icons/cross.png" alt="Delete" />
           </a>
				</td>
			</tr>
