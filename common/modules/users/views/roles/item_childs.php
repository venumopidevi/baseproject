        ...
        <?php if (count($rows)): ?>
          ...
          <?php foreach ($rows as $row): ?>
            <tr>
              ...
              <td><a href="<?php echo $this->createUrl('roles/viewauthitem', array('parent' => $row->child)); ?>" title="<?php echo Yii::t('adminroles', 'View Auth Item'); ?>" ><?php echo CHtml::encode($row->child); ?></a></td>
              <td>
                <!-- Icons -->
                <a href="<?php echo $this->createUrl('roles/deleteauthitemchild', array('parent' => $row->parent, 'child' => $row->child)); ?>" title="<?php echo Yii::t('adminroles', 'Delete this relationship!'); ?>" >Delete This Relation Ship</a>
              </td>
            </tr>
          <?php endforeach ?>
