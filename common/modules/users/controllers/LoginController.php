...
//        // echo Yii::app()->user->role,'  ', AuthManager::Admin; 
//        if(Yii::app()->user->role == AuthManager::Admin){
//          echo "helloooooooooooooo";exit();
//        }
    ...
    // Load facebook
    Yii::import('users.extensions.facebook.facebookLib');
  ...
  public function actionFacebookLogin() {
    ...
    // Load facebook
    Yii::import('backend.modules.users.extensions.facebook.facebookLib');
    $facebook = new facebookLib(array('appId' => Yii::app()->params['facebookappid'], 'secret' => Yii::app()->params['facebookapisecret'], 'cookie' => true, 'disableSSLCheck' => false));
    facebookLib::$CURL_OPTS[CURLOPT_CAINFO] = Yii::getPathOfAlias('ext.facebook') . '/ca-bundle.crt';
