<?php
/*YII-forum
 * These module implements concept of web forums, in which new topic can be added and comments can be given on posted topics.
 * Please make sure that in your login procudure isAdmin property should be set either true or false.
 */
...
class ForumModule extends CWebModule
{
    ...
    {   
        ...
        $date = date($dateFormat, (int)$timestamp);
        $time = date($timeFormat, (int)$timestamp);
