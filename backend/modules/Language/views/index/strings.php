<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-content">
			<?php $this->widget('language.widgets.pager', array( 'pages' => $pages )); ?>
			<?php echo CHtml::form(); ?>
			<table>
				<thead>
					<tr>
							...
							<tr>
							    ...
							    <td>&nbsp;
							    	<?php if( $string->translation != $orig->message ): ?>
										<a href="<?php echo $this->createUrl('revert', array( 'id' => $string->language, 'string' => $string->id )); ?>" title="<?php echo Yii::t('adminlang', 'Revert translation to original'); ?>" >
